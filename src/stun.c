...
/*With this function, we can tell the STUN server to which address it has to send the STUN replies.
 * The reply_sock is the socket where the reply from the server should be sent.*/
int stun_request_response_address(int s, int reply_sock, struct sockaddr_in *dst, struct sockaddr_in *answer,
